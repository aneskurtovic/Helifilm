...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="relative py-24 lg:py-32 bg-[#0a0f1a]">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, i) => (
            <motion.div
              ...
              whileHover={{ y: -4 }}
              className="p-8 rounded-2xl bg-white/[0.03] border border-[#1e3a8a]/20 hover:border-[#D4A418]/20 transition-all duration-300 relative"
            >
